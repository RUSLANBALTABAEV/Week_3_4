// Week_3_4_Task_2_Listing_25.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	case 2: cout << "В феврале 28 дней "; break;
